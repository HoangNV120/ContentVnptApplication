...
using ContentVnptApplication.Filters;
...
namespace ContentVnptApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user.IsDeleted)
            {
                ModelState.AddModelError("", "Tài khoản đã bị xoá");
                return View(model);
            }
            ...
            {
                ModelState.AddModelError("", "Vui lòng xác thực email trước khi đăng nhập");
                return View(model);
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await UserManager.SendEmailAsync(
                    user.Id,
                    "Xác nhận tài khoản",
                    $"Click vào link để xác nhận: <a href='{callbackUrl}'>Xác nhận</a>"
                );
